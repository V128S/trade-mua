    ...
    return (
      <div className="flex flex-col items-center text-center gap-8 py-12">
        ...
        <div className="space-y-2">
          <h1 className="font-headline-md text-headline-md text-on-surface uppercase tracking-widest">{t('emptyTitle')}</h1>
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 items-start">
      ...
      <div className="bg-card border-card rounded-lg p-6 space-y-4 lg:sticky lg:top-24">
        <h2 className="font-headline-md text-headline-md text-on-surface uppercase tracking-widest text-base">{t('summary')}</h2>
        ...
        <div className="space-y-2">
          {promo ? (
            <div className="flex justify-between items-center font-body-md text-body-md">
              <span className="text-on-surface-variant">{t('promoApplied', { code: promo.code, pct: promo.pct })}</span>
